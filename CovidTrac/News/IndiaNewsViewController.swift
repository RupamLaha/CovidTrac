...
extension IndiaNewsViewController: UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! IndiaNewsTableViewCell
    
            cell.title.text = titleArray[indexPath.row]
            cell.descripNews.text = contentArray[indexPath.row]
            cell.img.sd_setImage(with: imgUrlArray[indexPath.row] as URL)
